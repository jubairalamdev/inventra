          ...
          {isLoggedIn ? (
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="flex items-center gap-2 rounded-full bg-gaming-purple px-3 py-1.5 text-sm font-medium text-white transition-colors hover:bg-gaming-purple/80"
              >
                {initials}
